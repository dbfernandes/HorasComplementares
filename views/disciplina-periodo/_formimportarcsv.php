...
<div class="disciplina-periodo-formimportarcsv">
	<?php 
	if (!empty($erroFatal)) 
	{ ?>
    ...
    { ?>
	    ...
	    <div class="form-group">
	    	<?= Html::a('Cancelar', ['disciplina-periodo/index'], ['class' => 'btn btn-danger']) ?>
	...
	{ ?>
		...
		<a href="index.php?r=disciplina-periodo/index" class="btn btn-primary btn-large">Visualizar Lista</a>
