 ...
 * @property Periodo $periodoinscricao
 */
class Monitoria extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(Periodo::className(), ['id' => 'IDperiodoinscr']);
    }
    ...
    public function afterFind()
    {
        ...
        $periodo = Periodo::findOne(['id' => $this->IDperiodoinscr]);
        $this->IDperiodoinscr = $periodo->codigo;
